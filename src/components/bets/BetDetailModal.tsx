...
import { Copy, ExternalLink, X, Dices, Zap, Flame, TrendingUp, Spade, Coins } from 'lucide-react';
...
export function BetDetailModal({ bet, isOpen, onClose }: BetDetailModalProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className="bg-[#1a2c38] border-[#2f4553] text-white max-w-md p-0 overflow-hidden">
                {/* Header */}
